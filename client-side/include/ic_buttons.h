...
extern void button_1_pressed_work_handler(struct k_work *work);
extern void button_2_pressed_work_handler(struct k_work *work);
extern void button_3_pressed_work_handler(struct k_work *work);
extern void button_4_pressed_work_handler(struct k_work *work);
